...
app_mode = st.sidebar.selectbox(
    ...
    ['Home','How could this app be useful', 'Payment category Analysis' , 'Map Transaction Analysis', 'User Activity', 'Top Locations based on Transaction data',
...
if app_mode == 'Home':
    ...
    st.image("PhonePe logo.png",width=700)
   
   
elif app_mode == 'How could this app be useful':
