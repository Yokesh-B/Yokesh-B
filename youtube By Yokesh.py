...
# connection with MongoDB Compass and Creating a  database as (youtube_data)
client = pymongo.MongoClient("mongodb://localhost:27017/")
db = client["youtube_data"]
# CONNECT WITH MYSQL WorKbench DATABASE
...
#STREAMLIT PAGE 
icon = Image.open(r'C:\Users\Dell\Documents\data science\youtube_logo.png')
st.set_page_config(page_title= "Youtube",
                   page_icon= icon,
                   layout= "wide",
                   initial_sidebar_state= "expanded",
                   menu_items={'About': """# app is created by *Yokesh*"""})
# SIDEBAR 
with st.sidebar:
...
# BUILDING WITH YOUTUBE API
api_key = "AIzaSyDKI8AqPrp4poQwYnqfazLgEqVH5OGHPwQ"
